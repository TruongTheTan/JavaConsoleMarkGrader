...
{
	public class StudentGetService : StudentService
	{




		public StudentGetService(IMapper mapper, UnitOfWork unitOfWork, UserManager<IdentityUser> userManager) : base(mapper, unitOfWork, userManager)
		{
		}
